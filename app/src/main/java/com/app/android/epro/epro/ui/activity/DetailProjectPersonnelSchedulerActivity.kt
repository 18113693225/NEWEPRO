...
import com.app.android.epro.epro.ui.adapter.DetailProjectPersonnelSchedulerAdapter
...
import kotlinx.android.synthetic.main.detail_project_personnel_scheduler.*
import kotlinx.android.synthetic.main.include_detail_bar.*
import kotlinx.android.synthetic.main.include_detail_top.*
import org.greenrobot.eventbus.EventBus

class DetailProjectPersonnelSchedulerActivity : BaseDetailActivity(), ProcessInfoContract.View,
    InfoBottomFragment.RefreshActivity {

    private lateinit var info: DetailProjectPersonnelSchedulerBean
    private lateinit var id: String
    private lateinit var menu: String
    private lateinit var jobId: String
    private var from: String = "-1"
    private var mAdapter: DetailProjectPersonnelSchedulerAdapter? = null
    ...
    override fun layoutId(): Int {
        return R.layout.detail_project_personnel_scheduler
    }
    ...
    override fun setDetailInfoData(data: Any) {
        info = data as DetailProjectPersonnelSchedulerBean
        when (info.code) {
            0 -> {
    ...
    private fun setView(info: DetailProjectPersonnelSchedulerBean.Data.Object) {
        ...
        dispatchRemark.text =
            if (info.dispatchRemark.isEmpty()) CustomUtils.emptyInfo else info.dispatchRemark


        if (info.itemDispatchDetailList.isNullOrEmpty()) {
            list_ll.isVisible = false
        } else {
            list_ll.isVisible = true
            mAdapter =
                DetailProjectPersonnelSchedulerAdapter(info.itemDispatchDetailList as MutableList<DetailProjectPersonnelSchedulerBean.Data.Object.ItemDispatchDetail>)
