...
import com.app.android.epro.epro.mvp.model.bean.DetailTaxCertificateBackBean
...
import kotlinx.android.synthetic.main.detail_tax_ertificate_back.*
import kotlinx.android.synthetic.main.include_detail_bar.*
import kotlinx.android.synthetic.main.include_detail_top.*
import org.greenrobot.eventbus.EventBus

class DetailTaxCertificateBackActivity : BaseDetailActivity(), ProcessInfoContract.View,
    InfoBottomFragment.RefreshActivity {

    private lateinit var info: DetailTaxCertificateBackBean
    ...
    override fun layoutId(): Int {
        return R.layout.detail_tax_ertificate_back
    }
    ...
    override fun setDetailInfoData(data: Any) {
        info = data as DetailTaxCertificateBackBean
        when (info.code) {
            0 -> {
    ...
    private fun setView(info: DetailTaxCertificateBackBean.Data.Object) {
        ...
        backProjectName.text = info.backProjectName
        backPartyName.text = info.backPartyName
        backApplyUserName.text = info.backApplyUserName
        backApplyUnitName.text = info.backApplyUnitName
        backApplyDepartmentName.text = info.backApplyDepartmentName
        backNotice.text =
            if (info.backNotice.isEmpty()) CustomUtils.emptyInfo else info.backNotice
